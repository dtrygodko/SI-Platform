...
var UsersListPage = /** @class */ (function () {
    function UsersListPage(navCtrl, items, modalCtrl) {
     ...
     */
    UsersListPage.prototype.addItem = function () {
        var _this = this;
     ...
     */
    UsersListPage.prototype.deleteItem = function (item) {
        this.items.delete(item);
    };
    /**
     * Navigate to the detail page for this item.
     */
    UsersListPage.prototype.openItem = function (item) {
